var all_products = [
  ...
  },
  {
    id: 11,
    title:
      "Silicon Power 256GB SSD 3D NAND A55 SLC Boost SATA III 2.5",
    price: 109,
    description:
  ...
  },
  {
    id: 12,
    title:
      "WD 4TB Gaming Drive Portable External Hard Drive",
    price: 114,
    description:
  ...
  },
  {
    id: 16,
    title:
      "Lock and Love Women's Removable Hooded Faux Moto Biker Jacket",
    price: 29.95,
    description:
  ...
  {
    id: 19,
    title: "Opna Women's Short Sleeve Moisture  Exclusive",
    price: 7.95,
    description:
...
for (i = 0; i < all_products.length; i++) {
  ...
  var element = ` <div class="lg:w-1/4 md:w-1/4 p-4 my-2 mx-0 border-2 border-amber-500 border-y-transparent border-r-transparent rounded my-1">
            ...
            src="${all_products[i].image}">
            </a>
            <div class="mt-4 flex flex-col h-40">
